...
// Form schema validation (reuse the event schema but make id optional for creation)
          ...
          <div className="max-w-md mx-auto">
            <Alert className="bg-green-50 border-green-200">
              ...
              <AlertDescription className="text-green-700">
                Your tennis event has been created successfully. Redirecting to event details...
              </AlertDescription>
            </Alert>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-md mx-auto">
            <Alert variant="destructive">
              ...
              <Button className="mt-4 w-full bg-[#a3e635] text-black hover:bg-[#84cc16]" onClick={() => setError(null)}>
                Try Again
              </Button>
            </Alert>
          </div>
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">Create a Tennis Event</h1>
          <p className="text-gray-600 mb-8">Schedule a tennis session and find players to join you</p>

          <Card>
            <CardHeader>
              <CardTitle>Event Details</CardTitle>
              <CardDescription>Fill out the information below to create your tennis event</CardDescription>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-md p-4 flex items-start gap-3">
                      ...
                      <div className="text-sm text-blue-700">
                        ...
                        <p className="mt-1">
                          By creating this event, you agree to show up on time and notify participants of any changes.
